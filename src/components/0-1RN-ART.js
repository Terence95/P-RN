...
var HEART_SVG = "M130.4-0.8 c25.4 0 46 20.6 46 46.1 0 13.1-5.5 24.9-14.2 33.3L88 153.6 12.5 77.3c-7.9-8.3-12.8-19.6-12.8-31.9 0-25.5 20.6-46.1 46-46.2 19.1 0 35.5 11.7 42.4 28.4C94.9 11 111.3-0.8 130.4-0.8"
// var HEART_SVG = "M80 80A 45 45, 0, 0, 0, 125 125 L 125 80 Z";
...
export default  class ArtAnimView extends Component {
    ...
    componentDidMount(){
        ...
        setInterval(this.explode, 2000);
    }

    render() {
        var heart_scale = this.state.animation.interpolate({
            inputRange: [0, .01, 6, 10, 12, 28, 28],
            outputRange: [1, 0, .1, 1, 1.2, 10, 1],
            extrapolate: 'clamp'
        });
